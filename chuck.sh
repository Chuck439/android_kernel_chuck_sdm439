...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	echo " "
		msg "|| Cloning SilonT Clang ||"
		git clone --depth=1 -b master https://github.com/silont-project/silont-clang clang
...
gen_zip() {
	...
	cd AnyKernel3 || exit
	zip -r9 $ZIPNAME-$DEVICE-"$DATE"-kud.zip * -x .git README.md LICENSE

	## Prepare a final zip variable
	ZIP_FINAL="$ZIPNAME-$DEVICE-$DATE-$DRONE_BUILD_NUMBER-kud.zip"
	if [ "$PTTG" = 1 ]
